...
export default function ColorPickerComponent() {
  ...
  const copyToClipboard = (): void => {
    ...
    alert("Copied Successfully!"); // Alert the user that the color was copied
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <Card className="w-full max-w-md mx-auto p-8 grid gap-8">
        ...
        {/* Footer with developer's information */}
        <div className="text-center text-2xl text-green-950 pt-4">
          <p>Developed by Abdul Rehman</p>
        </div>
      </Card>
    </div>
  );
